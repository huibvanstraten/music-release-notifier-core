...
//            RabbitMQMessagePublisher(rabbitTemplate, "test")
//        }
//        assertThat(ex.message).contains("publisher-confirm-type")
//    }
//
//    @Test
...
//            RabbitMQMessagePublisher(rabbitTemplate, "test")
//        }
//        assertThat(ex.message).contains("publisher-returns")
//    }
//
//    @Test
...
//            RabbitMQMessagePublisher(rabbitTemplate, "test")
//        }
//        assertThat(ex.message).contains("mandatory")
//    }
//
//    @Test
...
//
//        val publisher = RabbitMQMessagePublisher(rabbitTemplate, "test")
//
...
//        }
//
//        assertThat(ex.message).contains("not acknowledged")
//    }
//
//    @Test
...
//        }
//
//        assertThat(ex.message).contains("returned_message_not_null")
//    }
//
//    @Test
...
//        }
//
//        assertThat(ex.message).contains("not confirmed in time")
//    }
//
